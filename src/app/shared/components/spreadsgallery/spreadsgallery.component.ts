...
import {Gallery2ServiceService, House} from '../../services/gallery2-service.service';
...
@Component({
  selector: 'app-spreadsgallery',
  templateUrl: './spreadsgallery.component.html',
  styleUrls: ['./spreadsgallery.component.scss'],
  providers: [Gallery2ServiceService]
})
export class SpreadsgalleryComponent {
  houses: House[];
  currentHouse: House;
  popupVisible = false;
